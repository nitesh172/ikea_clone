...
export const Right_signup = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    axios
      .post("https://ikeaserver.herokuapp.com/register", formData)
    axios
      .post("https://ikeaserver.herokuapp.com/cart", {
        ...
        <div className="form-group family">
          ...
          <div className="radio-div">
            <label className="radio-label-container">
              ...
              <u style={{ color: "#555" }}>Get the details</u>
              <input
                type="radio"
                name="member"
                value={true}
          ...
          <div className="radio-div">
            <label className="radio-label-container">
              ...
              another day.<u style={{ color: "#555" }}>Get the details</u>
              <input
                type="radio"
                name="member"
                value={false}
